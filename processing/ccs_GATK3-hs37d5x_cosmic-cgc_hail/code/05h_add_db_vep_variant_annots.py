...
vds_mgrb = hc.read('../ccs.cosmic_cgc.minrep.locusannot.vds')
...
vds_mgrb = (vds_mgrb
    ...
    .annotate_variants_expr('va = select(va, locus, variant, alleles)')
)

# TODO: Add gene-level annotations (eg GAVIN, RVIS)

vds_mgrb.write('../ccs.cosmic_cgc.minrep.locusannot.tgp.hrc.gnomad.dbsnp.clinvar.cato.eigen.vep.vds')
