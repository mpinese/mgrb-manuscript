...
vds = (vds
    ...
    .filter_variants_expr('''
        (
            ...
            va.alleles[va.aIndex-1].annotation.vep.consequences.impact_class == "MODERATE"
        ) &&
        (
...
(vds
    .export_genotypes('../ccs.cosmic_cgc.minrep.locusannot.tgp.hrc.gnomad.dbsnp.clinvar.cato.eigen.vep.goi.genotypes.rare.nonsyn.txt', expr='''
        SampleID = s,
        Variant = v,
