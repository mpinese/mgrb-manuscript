...
annotated_vds.write('test_vars_annotfixed.vds')
annotated_vds.export_vcf('test_vars_annotfixed.vcf.bgz')
annotated_vds.export_variants('test_vars_annotfixed.tsv', 'variant = v, va.info.*')
